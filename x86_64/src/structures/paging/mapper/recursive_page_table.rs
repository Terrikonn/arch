...
impl<'a> RecursivePageTable<'a> {
        ...
        A: FrameAllocator<Size4KiB> + ?Sized,
    {
        ...
        let p3 = unsafe { Self::create_next_table(&mut p4[page.p4_index()], p3_page, parent_table_flags, allocator)? };
        ...
        A: FrameAllocator<Size4KiB> + ?Sized,
    {
        ...
        let p2 = unsafe { Self::create_next_table(&mut p3[page.p3_index()], p2_page, parent_table_flags, allocator)? };
        ...
        A: FrameAllocator<Size4KiB> + ?Sized,
    {
        ...
        let p1 = unsafe { Self::create_next_table(&mut p2[page.p2_index()], p1_page, parent_table_flags, allocator)? };
...
fn p3_page<S: PageSize>(page: Page<S>, recursive_index: PageTableIndex) -> Page {
    Page::from_page_table_indices(recursive_index, recursive_index, recursive_index, page.p4_index())
}
...
fn p2_page<S: NotGiantPageSize>(page: Page<S>, recursive_index: PageTableIndex) -> Page {
    Page::from_page_table_indices(recursive_index, recursive_index, page.p4_index(), page.p3_index())
}
...
fn p1_page(page: Page<Size4KiB>, recursive_index: PageTableIndex) -> Page {
    Page::from_page_table_indices(recursive_index, page.p4_index(), page.p3_index(), page.p2_index())
}
